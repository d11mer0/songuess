...
const handleAuthSuccess = (state: UserState, action: PayloadAction<unknown>) => {
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addMatcher(authApi.endpoints.refresh.matchFulfilled, handleAuthSuccess)
      ...
      .addMatcher(authApi.endpoints.googleLogin.matchFulfilled, handleAuthSuccess)
