...
const PlaylistPage: React.FC = () => {
  ...
  const { data: playlistDetails, isLoading: isLoadingTracks } = useGetPlaylistByIdQuery(selectedPlaylistId!, {
  ...
  return (
    <div>
      ...
      <PlaylistSearch searchTerm={searchTerm} setSearchTerm={setSearchTerm} onSelect={setSelectedPlaylistId} />
