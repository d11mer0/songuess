...
export class SongsController {
  ...
  @ApiResponse({ status: 200, description: 'Список пісень', type: [SongResponseDto] })
  getAllSongs() {
  ...
  @ApiResponse({ status: 200, description: 'Знайдена пісня', type: SongResponseDto })
  ...
  @ApiResponse({ status: 201, description: 'Пісня успішно створена', type: SongResponseDto })
  @ApiCreateSong
  ...
  @ApiResponse({ status: 200, description: 'Пісня оновлена', type: SongResponseDto })
  @ApiResponse({ status: 404, description: 'Пісня не знайдена' })
  @ApiUpdateSong
